  ...
  jsonfile.readFile(file, (err, obj) => {
    ...
    if (err) {
      ...
      return;
        ...
        console.log(obj.recipes[recipes.id]);
        console.log(contents.title + "Hey good looking");
        obj.recipes[recipes.id].title = contents.title;
        obj.recipes[recipes.id].ingredients = contents.ingredients;
        obj.recipes[recipes.id].instructions = contents.instructions;
    jsonfile.writeFile(file, obj, err => {
      if (err) console.log(err);
      const data = {
