                            ...
                            <div className="col">
                                <form  method="POST" action={link}>
                                    <div className="form-group">
                                        ...
                                        <input type="text" id="exampleFormControlInput1" className="form-control" name="id" defaultValue={this.props.id} readOnly />
                                    </div>
                                    <div className="form-group">
                                        <label>Date created: </label>
                                        <input type="text" id="exampleFormControlInput1" className="form-control" name="dateCreated" defaultValue={this.props.dateCreated} readOnly />
                                    </div>

                                    <br/>
                                    <div className="form-group">
                                        <label>Recipe Title</label>
                                        <input type="text" className="form-control" id="exampleFormControlInput1" name="title" defaultValue={this.props.title} maxLength="50" required/>
                                    </div>
