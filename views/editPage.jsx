...
class Editpage extends React.Component {
  ...
  render() {
    ...
    let editTitle = this.props.passObj.title;
    let editIngre = this.props.passObj.ingredients;
    let editInstruc = this.props.passObj.instructions;
    let editIndex = this.props.passObj.index;
      ...
      <html>
        ...
        <body>
          ...
          <div className="formWidth boxshadow">
            <form action={'/recipes/' + editIndex + '?_method=PUT'} method="post">
