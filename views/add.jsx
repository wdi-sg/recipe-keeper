    ...
    render() {
        ...
        return (
            ...
            <div class="form-group">
                ...
                <input class="form-control form-control-lg" id="exampleFormControlInput1" type="text" name="title"/>
                <label for="exampleFormControlInput1 add-title">Ingredients</label>
                <input class="form-control form-control-lg" id="exampleFormControlInput1" type="text" name="ingredients"/>
                <label for="exampleFormControlInput1 add-title">Instructions</label>
                <input class="form-control form-control-lg" id="exampleFormControlInput1" type="text" name="instructions"/>
