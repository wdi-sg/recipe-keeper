...
class FormAdd extends React.Component {
  render() {
    ...
    return (
      ...
      <h3>Title</h3>
      <input className="my-4" type="text" name="title"/>
      <h3>Preparation Time</h3>
      <div className="input-group my-4 w-25">
      <select className="custom-select" id="prepTime" name="prepTime">
      ...
      <h3>Ingredients</h3>
      <select className="selectpicker my-4" multiple data-live-search="true" name="ingredients">
      {options}
      </select>
      <h3>Preparation</h3>
      <input className="my-4" type="textarea" name="preparation"/>
      <br/>
      <input className="my-4" type="submit" value="Create"/>
      </div>
      </form>
      </main>
